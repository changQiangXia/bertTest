...
_TRAINING_FILE = "https://www.modelscope.cn/api/v1/datasets/damo/msra_ner/repo/files?Revision=master&FilePath=train.txt"
_TEST_FILE = "https://www.modelscope.cn/api/v1/datasets/damo/msra_ner/repo/files?Revision=master&FilePath=test.txt"
            ...
            features=datasets.Features(
                {
                    ...
                    "spans": [{
                        ...
                        'end': datasets.Value('int32'),  # close
